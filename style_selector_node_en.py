...
class StyleSelectorNodeEn:
    ...
    def apply_style(self, prompt, style_name):
        ...
        if selected_style:
            ...
            print(f"[StyleSelectorNodeEn] Selected Style: {style_name}")
            print(f"[StyleSelectorNodeEn] Positive Prompt: {positive_prompt_out}")
            print(f"[StyleSelectorNodeEn] Negative Prompt: {negative_prompt_out}")
...
# -----------------------------------------------------------------
NODE_CLASS_MAPPINGS = {
    "StyleSelectorNodeEn": StyleSelectorNodeEn
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "StyleSelectorNodeEn": "Style Selector"
}