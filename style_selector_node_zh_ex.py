...
juese_list = [
    ...
    },
    {
        ...
        "prompt": "性別: 女性, 年齢: 21歳, 場所: カフェ / 東京の街角, 身長: 159cm, 体重: スリム, 体型: 柔らかく女性らしい, 髪色: おろしたロングのダークブラウンヘア, 柔らかな毛先のストレート, トレードマークのシースルーバング（ぱっつん）, 姫カット気味のサイドヘア, 目の色: 優しげな大きな焦げ茶色の瞳, 身体的特徴: 肌: 色白で透明感がある; 顔立ち: 柔らかな卵型, 可愛い鼻, ぷっくりとしたピンクの唇; スタイル: スリムだが柔らかい質感, 彼女感, トレンディなカジュアルファッションやニットウェア, 上品で清楚な雰囲気。",
    },
    {
